...
local function get_col_eclipse(eclipse)
	if eclipse == "solar" then return G.C.RED end
	if eclipse == "lunar" then return G.C.BLUE end
	return G.C.GREY 
...
SMODS.Joker {
	...
	loc_vars = function (self, info_queue, card)
		return {
			vars = {
				card.ability.extras.eclipse ~= "?" and localize("k_worm_jtem2_eclipse_"..card.ability.extras.eclipse) or "???",
				colours = {
	...
	func = function(self, layer)
		if self.config.center.key == "j_worm_jtem2_eclipse" then
			if (not (self.children.worm_jtem2_sun)) and (self.ability.extras.has_sun) then
				self.children.worm_jtem2_sun = SMODS.create_sprite(0, 0, G.CARD_W,G.CARD_H, "worm_jtem2_eclipse_planets", { x = 0, y = 0} )
			...
			if (not (self.children.worm_jtem2_moon_solar_eclipse)) and (self.ability.extras.eclipse == "solar") then
				self.children.worm_jtem2_moon_solar_eclipse = SMODS.create_sprite(0, 0, G.CARD_W,G.CARD_H, "worm_jtem2_eclipse_planets", { x = 1, y = 0} )
        		self.children.worm_jtem2_moon_solar_eclipse:set_role({major = self, role_type = 'Minor', draw_major = self})
			end
			...
			if (not (self.children.worm_jtem2_earth_solar_eclipse)) and ((self.ability.extras.eclipse == "solar") and self.ability.extras.eclipse_done) then
				self.children.worm_jtem2_earth_solar_eclipse = SMODS.create_sprite(0, 0, G.CARD_W,G.CARD_H, "worm_jtem2_eclipse_planets", { x = 2, y = 0} )
        		self.children.worm_jtem2_earth_solar_eclipse:set_role({major = self, role_type = 'Minor', draw_major = self})
			end
			if (self.children.worm_jtem2_earth_solar_eclipse) and (not ((self.ability.extras.eclipse == "solar") and self.ability.extras.eclipse_done)) then
			...
			if (not (self.children.worm_jtem2_earth_lunar_eclipse)) and (self.ability.extras.eclipse == "lunar") then
				self.children.worm_jtem2_earth_lunar_eclipse = SMODS.create_sprite(0, 0, G.CARD_W,G.CARD_H, "worm_jtem2_eclipse_planets", { x = 1, y = 1} )
        		self.children.worm_jtem2_earth_lunar_eclipse:set_role({major = self, role_type = 'Minor', draw_major = self})
			end
			...
			if (not (self.children.worm_jtem2_moon_lunar_eclipse)) and ((self.ability.extras.eclipse == "lunar") and self.ability.extras.eclipse_done) then
				self.children.worm_jtem2_moon_lunar_eclipse = SMODS.create_sprite(0, 0, G.CARD_W,G.CARD_H, "worm_jtem2_eclipse_planets", { x = 2, y = 1} )
        		self.children.worm_jtem2_moon_lunar_eclipse:set_role({major = self, role_type = 'Minor', draw_major = self})
			end
			if (self.children.worm_jtem2_moon_lunar_eclipse) and (not ((self.ability.extras.eclipse == "lunar") and self.ability.extras.eclipse_done)) then
